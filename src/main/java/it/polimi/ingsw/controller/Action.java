...
public class Action {
    ...
    public static void moveFromEntranceToDining(Color student, SchoolBoard schoolBoard) throws FullDiningRoomException {
    ...
    public static void moveFromEntranceToIsland(Color student, Entrance entrance, Island island) {
