...
class Char1Test {
    ...
    @Test
    public void testChar1() throws NotEnoughCoinsException, InvalidInputException, AlreadyPlayedCharacterException {
        ...
        characterController.applyEffect(char1.getValue());
